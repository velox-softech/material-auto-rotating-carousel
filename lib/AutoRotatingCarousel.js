      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              AutoRotatingCarousel.__proto__ ||
              Object.getPrototypeOf(AutoRotatingCarousel)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
    ...
    },
    {
      ...
      value: function onChange(slideIndex) {
        if (this.props.onChange) {
          this.props.onChange(
            (0, _util.modulo)(slideIndex, this.props.children.length)
          );
        }
      }
    },
    {
      ...
      value: function render() {
        ...
        var _props = this.props,
          ...
          arrowCircleColor = _props.arrowCircleColor,
          hideDots = _props.hideDots;
          ...
          _extends(
            {
              className: (0, _classnames2.default)(
                classes.root,
                _defineProperty({}, classes.rootMobile, mobile)
              ),
              open: open,
              onClose: onClose,
              BackdropComponent: _Backdrop2.default,
              BackdropProps: ModalProps
                ? _extends(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "div",
              {
                className: (0, _classnames2.default)(
                  classes.content,
                  _defineProperty({}, classes.contentMobile, mobile)
                ),
...
AutoRotatingCarousel.propTypes = {
  ...
  hideDots: _propTypes2.default.bool,

  arrowCircleColor: _propTypes2.default.string
};
